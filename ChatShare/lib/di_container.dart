...
void setupDependencies() {
  const String baseUrl = 'http://192.168.189.126:4000';
  ...
  sl.registerLazySingleton<ConversationsRepository>(()=> ConversationsRepositoryImpl(conversationRemoteDataSource: sl()));
  sl.registerLazySingleton<MessagesRepository>(()=> MessagesRepositoryImpl(remoteDataSource: sl()));
  sl.registerLazySingleton<ContactsRepository>(()=> ContactsRepositoryImpl(remoteDatasource: sl()));
  ...
  sl.registerLazySingleton(()=> FetchDailyQuestionUseCase(messagesRepository: sl()));
  ...
  sl.registerLazySingleton(()=> FetchRecentContactUseCase(contactsRepository: sl()));
